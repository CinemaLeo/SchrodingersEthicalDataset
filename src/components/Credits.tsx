  ...
  return (
    <div className="credits-screen">
      ...
      <div className="credits-content">
        <br />
        <h3>
          <a href="https://www.instagram.com/sahra.azd/" target="_blank" rel="noopener noreferrer">
            Sahra Azadzoy
          </a>{" "}
          &<br />{" "}
          <a href="https://www.leobaylybarton.com" target="_blank" rel="noopener noreferrer">
            Leo Bayly Barton
          </a>
        </h3>
        <br />
        <h4>{t("credits.basedOn")}</h4>
        <ul>
          <li>
            <a href="https://arxiv.org/pdf/2409.00252" target="_blank" rel="noopener noreferrer">
          ...
          <br />
          <li>
            {t("credits.imagesFrom")}{" "}
            <a href="https://www.kaggle.com/datasets/vekosek/cats-from-memes" target="_blank" rel="noopener noreferrer">
              'Cats from memes'
            </a>{" "}
            {t("credits.datasetWord")}
            <br />
            {t("credits.under")}{" "}
