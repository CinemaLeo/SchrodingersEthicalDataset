...
function AppInner(): JSX.Element {
  ...
  const progressToNextStage = (): void => {
    switch (gameStage) {
      case "stage0": setGameStage("stage1"); setCurrentStageCards(Stage1Cards); break;
      case "stage1": setGameStage("stage2"); setCurrentStageCards(Stage2Cards); break;
      case "stage2": setGameStage("stage3"); setCurrentStageCards(Stage3Cards); break;
      case "stage3": setGameStage("stage4"); setCurrentStageCards(Stage4Cards); break;
      case "stage4": setGameStage("stage5"); setCurrentStageCards(Stage5Cards); break;
      case "stage5": setGameStage("results"); break;
    }
  };

  const handleContinue = () => setGameStage("credits");

  const restartGame = (): void => {
    setGameStage("menu");
    setGameVariables({
      quantity: 50, privacy: 50, cultural: 50,
      racial: 50, class: 50, gender: 50, overall: 50,
    });
  };

  const isPlaying =
    gameStage === "stage0" || gameStage === "stage1" || gameStage === "stage2" ||
    gameStage === "stage3" || gameStage === "stage4" || gameStage === "stage5";
